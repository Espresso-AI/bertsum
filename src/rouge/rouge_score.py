...
class RougeScorer(scoring.BaseScorer):
    ...
    __doc__ = r"""
        It is the implementation of google-research, which is also proposed by Hugging Face.
        https://github.com/google-research/google-research/tree/master/rouge
        https://huggingface.co/spaces/evaluate-metric/rouge

        The separator between sentences must be a '\n'.

        Following the examples below, I recommend setting (use_stemmer=True, tokenizer=None).
