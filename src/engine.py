...
class ExtSum_Engine(pl.LightningModule):
    ...
    __doc__ = r"""
        ...
        According to SummaRuNNer, the extractive label made by oracle algorithm is only for training 
        the extractive model in binary classification way.
        To evaluate the model, the target must be an human-written abstractive label.  
